...
Fundamental concepts of the Salesforce platform, cloud models, and underlying architecture.
...
Core components of the Salesforce database, data structures, and underlying schema.
...
- [Future Methods – Asynchronous Processing](./Asynchronous-Apex/future-methods-async-processing)
